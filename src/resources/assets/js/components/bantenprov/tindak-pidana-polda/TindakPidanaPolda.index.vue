    ...
    <div class="card-body">
      ...
      <div class="table-responsive">
        <vuetable ref="vuetable"
          api-url="/api/tindak-pidana-polda"
          :fields="fields"
...
export default {
  ...
  methods: {
    createRow() {
      window.location = '#/admin/tindak-pidana-polda/create';
    },
    viewRow(rowData) {
      window.location = '#/admin/tindak-pidana-polda/' + rowData.id;
    },
    editRow(rowData) {
      window.location = '#/admin/tindak-pidana-polda/' + rowData.id + '/edit';
    },
    deleteRow(rowData) {
      let app = this;

      if (confirm('Do you really want to delete it?')) {
        axios.delete('/api/tindak-pidana-polda/' + rowData.id)
